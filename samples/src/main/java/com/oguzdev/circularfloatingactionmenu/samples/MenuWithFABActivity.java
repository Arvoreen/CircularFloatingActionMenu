...
public class MenuWithFABActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final FloatingActionMenu leftCenterMenu = new FloatingActionMenu.Builder(this)
                ...
                .setStartAngle(70)
                .setEndAngle(-70)
                .attachTo(createLeftCenterButton(fabIconStar))
                .build();

    }

    private View createLeftCenterButton(ImageView imageView) {
        ...
        starParams.setMargins(redActionButtonMargin,
                ...
                redActionButtonMargin,
                redActionButtonMargin);
        imageView.setLayoutParams(starParams);
        ...
        return new FloatingActionButton.Builder(this)
                .setContentView(imageView, fabIconStarParams)
